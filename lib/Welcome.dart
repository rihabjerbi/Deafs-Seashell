                        ...
                        Column(
                          children: [
                            ...
                            Container(
                                ...
                                child: TextButton(onPressed: (){}, child: Text('Sign up',style: TextStyle(color: Colors.white,fontFamily: 'Lato'),))),
                            SizedBox(height: 20.0,),
                            Container(
                                padding: EdgeInsets.symmetric(vertical: 2.0,horizontal: 100.0),
                                decoration: BoxDecoration(
                                ...
                                child: TextButton(onPressed: (){}, child: Text('Log in',style: TextStyle(color: Colors.white,fontFamily: 'Lato'),)))
                          ],
                        ),
                      ],
                    ),
